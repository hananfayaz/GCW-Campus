...
public class RecyclerStudentTimetableAdapter extends RecyclerView.Adapter<RecyclerStudentTimetableAdapter.ViewHolder> {

    ArrayList<RecyclerTimetableModel> timetableModel;
    Context context;

    public RecyclerStudentTimetableAdapter(Context context, ArrayList<RecyclerTimetableModel> timetableModel) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.timetable_student_card, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvFaculty.setText(timetableModel.get(position).getFaculty());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvSubject, tvStartTime, tvEndTime, tvFaculty, tvPeriod, tvDay;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tvFaculty = itemView.findViewById(R.id.txt_faculty);
            tvPeriod = itemView.findViewById(R.id.txt_period);
            tvDay = itemView.findViewById(R.id.txt_day_student);
        }
    }
}
